...
namespace philcare.Api.Features.Volunteers.GetVolunteerById;
        ...
        app.MapGet("/api/volunteers/{id:int}", async (int id, AppDbContext db, CancellationToken ct) =>
        {
            var volunteer = await db.Volunteers
                ...
                .Select(v => new VolunteerDetailResponse(
                    v.Id, v.FullName, v.Gender, v.Phone, v.Email, v.Barangay, v.City, v.Province, v.Region, v.Skills, v.Status,
